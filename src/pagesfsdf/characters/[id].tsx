...
const CharacterPage = ({ characterInfo }: InferGetStaticPropsType<typeof getStaticProps>) => {
  ...
  // if (characterInfo) {
  //   const imageFormat = characterInfo.attributes.info?.meta_img?.data?.attributes
  //     ? checkImageFormat(characterInfo.attributes.info?.meta_img?.data?.attributes?.formats)
  //     : "thumbnail";
  //
  //   return (
  //     <>
