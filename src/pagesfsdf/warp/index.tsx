...
const WarpFivestar = dynamic(() => import("widgets/warp-fivestar/ui").then((mod) => mod.WarpFivestar), { ssr: false });
const WarpStats = dynamic(() => import("widgets/warp-stats/ui").then((mod) => mod.WarpStats), { ssr: false });
const WarpInfo = dynamic(() => import("organisms/warp-info").then((mod) => mod.WarpInfo), { ssr: false });
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8 flex flex-wrap items-center gap-4 md:mb-16">
          <button
            ...
            className={clsx("btn", helpFor === "PC" ? "btn-primary" : "btn-ghost")}
          >
            Инструкция для PC
          </button>
          <button
            onClick={handleChangeHelp("iOS")}
            className={clsx("btn", helpFor === "iOS" ? "btn-primary" : "btn-ghost")}
          >
            Инструкция для iOS
          </button>
        </div>
        <section>
          {helpFor === "PC" && (
            <ul className="steps steps-vertical text-base">
              ...
              <li className="step-primary step">
                Сверните игру и откройте Windows PowerShell. Его можно найти воспользовавшись поиском в вашей системе.
              </li>
              <li className="step-primary step">
              ...
              <li className="step-primary step">
                <div className="flex flex-col items-start gap-2">
                  <p>
                    Результат выполнения скрипта должен автоматически скопироваться в буфер обмена. Вставьте результат
                    выполнения в поле ниже и нажмите кнопку <span className="text-orange">Импорт</span>:
                  </p>
                </div>
              </li>
            </ul>
            ...
            <>
              <ol className="relative border-l border-gray-200 text-white dark:border-gray-700 dark:text-gray-400">
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="font-medium leading-tight">Предварительные требования</h3>
                  <p className="text-sm">
                    Нам понадобиться программа для перехвата запросов. Установите Stream Network Debug Tool по этой{" "}
                    <a
                ...
                <li className="mb-10 ml-6">
                  ...
                  <h3 className="font-medium leading-tight">Предварительные требования</h3>
                  <p className="text-sm">
                    Убедитесь что Safari - Ваш браузер по умолчанию. (Необходимо для первичной настройки)
                  </p>
                </li>
              </ol>
              ...
              <ol className="relative border-l border-gray-200 text-white dark:border-gray-700 dark:text-gray-400">
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">
                    Откройте Stream и нажмите на кнопку Sniff Now. Далее программа запросит разрешение на добавление
                    конфигураций VPN. В открывшимся окне выберите Разрешить
                  </p>
                  <div>
                    <Image
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">
                    ...
                    установить CA сертификаты. Нажмите «Install CA». После чего нажмите «Install CA Certificate».
                    Откроется браузер Safari где появится всплывающее окно, где будет спрашиваться разрешение веб сайту
                    загрузить профиль конфигурации. Нажмите «Разрешить». Далее появится всплывающее окно сообщающее об
                    успехе, закройте его.
                  </p>
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">
                    ...
                    «Загруженный профиль» будет Stream Generated CA ***. Нажмите на него и в правом верхнем углу нажмите
                    на кнопку «Установить», далее следуйте инструкциям телефона.
                  </p>
                </li>
                <li className="mb-10 ml-6">
                  <span className="absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-blue-900 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-900">
                  ...
                  <p className="text-sm">
                    Вернетесь в приложение. Если у вас iOS 10.3 и выше, вы увидите всплывающее окно, которое запросит
                    дополнительную проверку. Нажмите «I’ve trusted».
                  </p>
                  <div>
                    <Image
                      className="w-full max-w-[15rem] object-contain"
              ...
              <h2 className="mb-10">Получение ссылки с информацией о прыжках</h2>
              ...
              <ol className="relative border-l border-gray-200 text-white dark:border-gray-700 dark:text-gray-400">
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">Запустите Honkai: Star Rail и перейдите на окно прыжков.</p>
                </li>
                <li className="mb-10 ml-6">
                  <span className="absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-blue-900 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-900">
                    2
                  </span>
                  <p className="text-sm">Откройте приложение Steam и кликните на «Sniff Now».</p>
                  <div>
                    <Image
                      className="w-full max-w-[15rem] object-contain"
                      width={790}
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">Вернетесь в Honkai: Star Rail и откройте свою историю прыжков.</p>
                </li>
                <li className="mb-10 ml-6">
                  <span className="absolute -left-4 flex h-8 w-8 items-center justify-center rounded-full bg-gray-100 text-blue-900 ring-4 ring-white dark:bg-gray-700 dark:ring-gray-900">
                    4
                  </span>
                  <p className="text-sm">Вернетесь в приложение Stream и нажмите на «Stop Sniffing».</p>
                  <div>
                    <Image
                      className="w-full max-w-[15rem] object-contain"
                      width={790}
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">Выберите самую верхнюю (последнюю) сессию.</p>
                  <div>
                    <Image
                      className="w-full max-w-[15rem] object-contain"
                      width={790}
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">
                    ...
                    «https://api-os-takumi.mihoyo.com/common/gacha...». Нажмите на неё.
                  </p>
                  <div>
                    <Image
                      className="w-full max-w-[15rem] object-contain"
                ...
                <li className="mb-10 ml-6">
                  ...
                  <p className="text-sm">
                    У вас откроется подробная информация о данном запросе. Перейдите во вкладку «Request» чтобы увидеть
                    её полностью. Ссылка под заголовком «REQUEST LINE» и есть ваша ссылка с информацией о прыжках.
                    Нажмите на неё и увидите всплывающее меню, в котором нажмите Copy Url. Затем скопированную ссылку
