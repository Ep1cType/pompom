...
export const TimelineHeader = ({ time, timebar: rows, onMove, onEnter, onLeave, width, sticky }: Props) => {
	const scrollRef = createRef<HTMLDivElement>();
	const timebarRef = createRef<HTMLDivElement>();

	const { isSticky, headerHeight, viewportWidth, setHeaderHeight, scrollLeft, handleHeaderScrollY } = sticky;
