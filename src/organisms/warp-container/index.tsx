      ...
      <section>
        {helpFor === "PC" && (
          <ul className="steps steps-vertical text-base">
            <li className="step-primary step">Запустите игру и откройте Историю прыжков (не важно на каком баннере)</li>
          ...
          <>
            ...
            <ol className="relative border-l border-gray-200 text-white dark:border-gray-700 dark:text-gray-400">
              ...
              <li className="mb-10 ml-6">
                ...
                <p className="text-sm">
                  У вас откроется подробная информация о данном запросе. Перейдите во вкладку «Request» чтобы увидеть её
                  полностью. Ссылка под заголовком «REQUEST LINE» и есть ваша ссылка с информацией о прыжках. Нажмите на
                  неё и увидите всплывающее меню, в котором нажмите Copy Url. Затем скопированную ссылку вставите на
                  сайте в поле ниже и нажмите кнопку «Импорт»
                </p>
                <div>
                  <Image
                    className="w-full max-w-[15rem] object-contain"
